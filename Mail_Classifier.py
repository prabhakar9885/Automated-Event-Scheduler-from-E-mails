...
def buildMailClassifier():
	...
	targets = [0]*len(keys)
	indexOfSchedulingMails = [1, 2, 8, 21, 29, 30, 37, 38, 55, 59, 61, 63, 68, 69, 74, 82, 92, 110 ,113 ,124 ,131 ,139, 161 ,171 ,194, 204, 213, 223, 255, 308, 323, 340, 365, 374, 392, 399, 403 ]
...
if __name__ == '__main__':
	...
	clf, count_vect, tfidf_transformer = buildMailClassifier()
